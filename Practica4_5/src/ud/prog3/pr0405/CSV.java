...
public class CSV { 
	...
	private static void procesaLineaDatos( ArrayList<Object> datos ) {
		numLin++;
		//System.out.println( numLin + "\t" + datos ); 
		UsuarioTwitter us = new UsuarioTwitter((String) datos.get(0), (String) datos.get(1), (ArrayList<String>) datos.get(2), (String) datos.get(3), (long) datos.get(4), (long) datos.get(5), (String) datos.get(6), (long) datos.get(7), (String) datos.get(8), (ArrayList<String>) datos.get(9));
		
		GestionTwitter.mapaUsuariosPorId.put(us.getId(), us);
		
		GestionTwitter.mapaUsuariosPorNick.put(us.getScreenName(), us);
	}
